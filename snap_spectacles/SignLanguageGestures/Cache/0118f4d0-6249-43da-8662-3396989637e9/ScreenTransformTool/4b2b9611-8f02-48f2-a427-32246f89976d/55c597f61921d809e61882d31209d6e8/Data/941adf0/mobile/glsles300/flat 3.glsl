...
vec3 l9_53=vec3(sin(sc_Time.x*1.0));
...
#endif
vec3 l9_73=mix(l9_70.xyz,definedBlend(l9_70.xyz,l9_54.xyz).xyz,vec3(l9_52));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_78=vec4(mix(vec3(1.0),l9_54.xyz,vec3(l9_52)),l9_52);
}
#else
{
vec4 l9_79;
...
#endif
vec4 l9_81=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_55,vec4(0.0)));
