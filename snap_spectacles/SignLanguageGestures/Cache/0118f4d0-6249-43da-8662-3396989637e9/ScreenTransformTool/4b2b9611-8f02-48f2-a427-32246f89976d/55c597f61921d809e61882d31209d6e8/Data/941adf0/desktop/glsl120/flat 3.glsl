...
vec3 l9_29=vec3(sin(sc_Time.x*Port_Multiplier_N033));
...
{
l9_34=clamp(dot(l9_30.xyz,vec3(l9_28)),0.0,1.0);
}
#else
{
float l9_35;
...
{
l9_36=(1.0-dot(l9_30.xyz,vec3(0.33333001)))*l9_28;
}
#else
{
float l9_37;
...
{
l9_37=(1.0-clamp(dot(l9_30.xyz,vec3(1.0)),0.0,1.0))*l9_28;
}
#else
{
float l9_38;
...
{
l9_38=clamp(dot(l9_30.xyz,vec3(1.0)),0.0,1.0)*l9_28;
}
#else
{
float l9_39;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_40=clamp(dot(l9_30.xyz,vec3(1.0)),0.0,1.0)*l9_28;
}
#else
{
float l9_41;
...
{
l9_41=dot(l9_30.xyz,vec3(0.33333001))*l9_28;
}
#else
{
float l9_42;
...
#else
{
vec2 l9_47=sc_ScreenCoordsGlobalToView(l9_0);
int l9_48;
...
#endif
vec3 l9_49=mix(l9_46.xyz,definedBlend(l9_46.xyz,l9_30.xyz).xyz,vec3(l9_28));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_54=vec4(mix(vec3(1.0),l9_30.xyz,vec3(l9_28)),l9_28);
}
#else
{
vec4 l9_55;
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_62=sc_ScreenCoordsGlobalToView(l9_0);
