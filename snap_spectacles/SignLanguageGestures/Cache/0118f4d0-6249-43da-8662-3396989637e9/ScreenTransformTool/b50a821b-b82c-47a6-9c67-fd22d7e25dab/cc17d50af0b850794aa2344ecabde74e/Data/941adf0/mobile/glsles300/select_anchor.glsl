...
{
vec2 l9_66;
Node122_If_else(0.0,vec2(0.0),vec2(0.0),l9_66,l9_2);
float l9_67;
Node67_Bool_Parameter(l9_67,l9_2);
l9_65=mix(varPackedTex.xy,l9_66,vec2(l9_67));
}
#else
{
vec2 l9_68;
...
{
vec2 l9_69;
Node64_If_else(0.0,vec2(0.0),vec2(0.0),l9_69,l9_2);
float l9_70;
Node11_Bool_Parameter(l9_70,l9_2);
l9_68=mix(varPackedTex.xy,l9_69,vec2(l9_70));
}
#else
{
l9_68=varPackedTex.xy;
}
#endif
l9_65=l9_68;
}
...
{
bool l9_72=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0));
float l9_73=l9_63.x;
...
float l9_88=l9_87.x;
float l9_89=l9_78;
sc_SoftwareWrapLate(l9_88,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,l9_72,l9_89);
float l9_90=l9_87.y;
float l9_91=l9_89;
sc_SoftwareWrapLate(l9_90,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,l9_72,l9_91);
float l9_92=l9_91;
...
#endif
float l9_120=l9_61.w*l9_62;
vec4 l9_121=vec4(l9_61.x,l9_61.y,l9_61.z,vec4(0.0).w);
l9_121.w=l9_120;
...
{
l9_124=clamp(l9_120*2.0,0.0,1.0);
}
#else
{
float l9_125;
...
{
l9_125=clamp(dot(l9_121.xyz,vec3(l9_120)),0.0,1.0);
}
#else
{
float l9_126;
...
{
l9_127=(1.0-dot(l9_121.xyz,vec3(0.33333001)))*l9_120;
}
#else
{
float l9_128;
...
{
l9_128=(1.0-clamp(dot(l9_121.xyz,vec3(1.0)),0.0,1.0))*l9_120;
}
#else
{
float l9_129;
...
{
l9_129=clamp(dot(l9_121.xyz,vec3(1.0)),0.0,1.0)*l9_120;
}
#else
{
float l9_130;
#if (sc_BlendMode_Add)
{
l9_130=clamp(dot(l9_121.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_131;
...
{
l9_132=dot(l9_121.xyz,vec3(0.33333001))*l9_120;
}
#else
{
float l9_133;
#if (sc_BlendMode_Min)
{
l9_133=1.0-clamp(dot(l9_121.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_134;
#if (sc_BlendMode_Max)
{
l9_134=clamp(dot(l9_121.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_134=1.0;
...
#endif
l9_122=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_121.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_123);
}
#else
{
vec4 l9_135;
...
#if (sc_FramebufferFetch)
{
l9_137=sc_readFragData0_Platform();
}
#else
{
vec2 l9_138=sc_ScreenCoordsGlobalToView(l9_0);
vec4 l9_139;
#if (sc_ScreenTextureLayout==2)
{
l9_139=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_138,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_139=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_138,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_137=l9_139;
}
#endif
vec3 l9_140=mix(l9_137.xyz,definedBlend(l9_137.xyz,l9_121.xyz).xyz,vec3(l9_120));
...
#endif
vec4 l9_148=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_122,vec4(0.0)));
vec4 l9_149=clamp(l9_148,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_150=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_150-0.0039215689)),min(1.0,l9_150+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_151=sc_ScreenCoordsGlobalToView(l9_0);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_151).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_152=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_151).xy);
float l9_153=packValue(l9_152);
int l9_160=int(l9_149.w*255.0);
float l9_161=packValue(l9_160);
sc_writeFragData0Internal(vec4(packValue(l9_152),packValue(l9_152),packValue(l9_152),packValue(l9_152)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_153,packValue(l9_152),packValue(l9_152),packValue(l9_152)));
sc_writeFragData2(vec4(l9_161,packValue(l9_160),packValue(l9_160),packValue(l9_160)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_164=sc_ScreenCoordsGlobalToView(l9_0);
#if (sc_OITMaxLayers4Plus1)
{
...
if (l9_169==0)
{
l9_172=texture(sc_OITAlpha0,l9_164);
l9_171=texture(sc_OITDepthLow0,l9_164);
l9_170=texture(sc_OITDepthHigh0,l9_164);
}
else
{
l9_172=vec4(0.0);
...
if (l9_169==1)
{
l9_175=texture(sc_OITAlpha1,l9_164);
l9_174=texture(sc_OITDepthLow1,l9_164);
l9_173=texture(sc_OITDepthHigh1,l9_164);
}
else
{
l9_175=l9_172;
...
if (any(notEqual(l9_173,vec4(0.0)))||any(notEqual(l9_174,vec4(0.0))))
{
int l9_176[8]=l9_165;
unpackValues(l9_173.w,l9_169,l9_176);
unpackValues(l9_173.z,l9_169,l9_176);
unpackValues(l9_173.y,l9_169,l9_176);
unpackValues(l9_173.x,l9_169,l9_176);
unpackValues(l9_174.w,l9_169,l9_176);
unpackValues(l9_174.z,l9_169,l9_176);
unpackValues(l9_174.y,l9_169,l9_176);
unpackValues(l9_174.x,l9_169,l9_176);
int l9_185[8]=l9_166;
unpackValues(l9_175.w,l9_169,l9_185);
unpackValues(l9_175.z,l9_169,l9_185);
unpackValues(l9_175.y,l9_169,l9_185);
unpackValues(l9_175.x,l9_169,l9_185);
}
l9_169++;
continue;
}
...
mediump vec4 l9_190=texture(sc_OITFilteredDepthBoundsTexture,l9_164);
...
if (l9_200)
{
vec3 l9_201=l9_194.xyz*(1.0-(float(l9_166[l9_196])/255.0));
...
sc_writeFragData0Internal(l9_194,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
