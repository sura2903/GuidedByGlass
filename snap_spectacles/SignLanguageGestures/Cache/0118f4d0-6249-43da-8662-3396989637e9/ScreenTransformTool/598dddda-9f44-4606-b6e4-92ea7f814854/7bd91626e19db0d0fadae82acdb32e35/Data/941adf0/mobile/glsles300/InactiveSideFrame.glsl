...
#else
{
vec2 l9_20=sc_ScreenCoordsGlobalToView(l9_0);
vec4 l9_21;
...
#endif
vec3 l9_22=mix(l9_19.xyz,definedBlend(l9_19.xyz,l9_3.xyz).xyz,vec3(l9_2));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_27=vec4(mix(vec3(1.0),l9_3.xyz,vec3(l9_2)),l9_2);
}
#else
{
vec4 l9_28;
...
#endif
l9_28=vec4(l9_3.xyz*l9_29,l9_29);
}
#else
{
l9_28=l9_3;
...
#endif
vec4 l9_30=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_4,vec4(0.0)));
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_32-0.0039215689)),min(1.0,l9_32+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_33=sc_ScreenCoordsGlobalToView(l9_0);
...
sc_writeFragData0Internal(vec4(packValue(l9_34),packValue(l9_34),packValue(l9_34),packValue(l9_34)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_35,packValue(l9_34),packValue(l9_34),packValue(l9_34)));
sc_writeFragData2(vec4(l9_43,packValue(l9_42),packValue(l9_42),packValue(l9_42)));
...
mediump vec4 l9_72=texture(sc_OITFilteredDepthBoundsTexture,l9_46);
vec2 l9_73=l9_72.xy;
int l9_74;
#if (sc_SkinBonesCount>0)
{
