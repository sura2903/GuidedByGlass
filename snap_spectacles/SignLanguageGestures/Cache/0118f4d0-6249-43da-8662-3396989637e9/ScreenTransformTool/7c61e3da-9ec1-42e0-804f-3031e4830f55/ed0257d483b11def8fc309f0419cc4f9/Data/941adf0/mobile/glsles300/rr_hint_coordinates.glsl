...
float l9_9=1.0-0.0;
float l9_10=l9_9+1e-06;
float l9_11=(shapeWidthX-0.0)/l9_10;
float l9_12=l9_7-l9_3;
float l9_13=(l9_11*l9_12)+l9_3;
float l9_14;
if (l9_7>l9_3)
{
l9_14=clamp(l9_13,l9_3,l9_7);
}
else
{
l9_14=clamp(l9_13,l9_7,l9_3);
}
float l9_15;
if (l9_6)
{
...
float l9_16=xOffset+l9_15;
float l9_17=l9_14+((1.0-l9_16)+0.0);
float l9_18=floor(float(yUpPin));
float l9_19;
if (l9_18==0.0)
{
l9_19=0.0;
...
float l9_21=floor(float(yDownPin));
bool l9_22=l9_21==0.0;
float l9_23;
if (l9_22)
{
l9_23=0.0;
...
float l9_25=(shapeHeightY-0.0)/l9_10;
float l9_26=l9_23-l9_19;
float l9_27=(l9_25*l9_26)+l9_19;
float l9_28;
if (l9_23>l9_19)
{
l9_28=clamp(l9_27,l9_19,l9_23);
}
else
{
l9_28=clamp(l9_27,l9_23,l9_19);
}
float l9_29;
if (l9_22)
{
...
float l9_30=yOffset+l9_29;
float l9_31=l9_28+(l9_30+0.0);
float l9_32=radians(0.0);
float l9_33=sin(l9_32);
float l9_34=cos(l9_32);
vec2 l9_35=(((varPackedTex.xy*vec2(1.0))+vec2(0.0))+vec2(l9_17,l9_31))-vec2(0.5);
vec2 l9_36=vec2(0.0);
l9_36.y=0.0/4.0;
float l9_37=radians(1.0-(0.0+1.0));
float l9_38=sin(l9_37);
float l9_39=cos(l9_37);
vec2 l9_40=((vec2(dot(vec2(l9_34,l9_33),l9_35),dot(vec2(-l9_33,l9_34),l9_35))+vec2(0.5))+l9_36)-vec2(0.5);
float l9_41=radians(shapeRotation);
float l9_42=sin(l9_41);
float l9_43=cos(l9_41);
vec2 l9_44=(vec2(dot(vec2(l9_39,l9_38),l9_40),dot(vec2(-l9_38,l9_39),l9_40))+vec2(0.5))-vec2(0.5);
vec2 l9_45=vec2(l9_43,l9_42);
vec2 l9_46=vec2(-l9_42,l9_43);
float l9_47=0.0-0.0;
vec2 l9_48=abs((((((vec2(dot(l9_45,l9_44),dot(l9_46,l9_44))+vec2(0.5))-vec2(0.5))*vec2(clamp(((l9_47/l9_10)*(0.80000001-1.005))+1.005,0.80000001,1.005)))+vec2(0.5))*vec2(2.0))+vec2(-1.0));
float l9_49=0.0/7.5;
float l9_50=1.0-l9_49;
float l9_51=l9_50-0.0;
float l9_52=(l9_11*l9_51)+0.0;
bool l9_53=l9_50>0.0;
float l9_54;
if (l9_53)
{
l9_54=clamp(l9_52,0.0,l9_50);
}
else
{
l9_54=clamp(l9_52,l9_50,0.0);
}
float l9_55=(l9_25*l9_51)+0.0;
float l9_56;
if (l9_53)
{
l9_56=clamp(l9_55,0.0,l9_50);
}
else
{
l9_56=clamp(l9_55,l9_50,0.0);
}
vec2 l9_57=vec2(l9_54,l9_56);
float l9_58=min(abs(shapeRoundness),l9_54);
float l9_59=min(l9_58,l9_56);
float l9_60=max(l9_59,0.001);
vec2 l9_61=vec2(l9_60);
float l9_62=1.0-(length(max((l9_48-l9_57)+l9_61,vec2(0.0)))/l9_60);
float l9_63=fwidth(l9_62);
float l9_64=0.0*2.5;
float l9_65=l9_62/((((l9_63-0.0)/1.000001)*(1.0-l9_64))+l9_64);
float l9_66=(l9_11*l9_50)+l9_49;
bool l9_67=1.0>l9_49;
float l9_68;
if (l9_67)
{
l9_68=clamp(l9_66,l9_49,1.0);
}
else
{
l9_68=clamp(l9_66,1.0,l9_49);
}
float l9_69=(l9_25*l9_50)+l9_49;
float l9_70;
if (l9_67)
{
l9_70=clamp(l9_69,l9_49,1.0);
}
else
{
l9_70=clamp(l9_69,1.0,l9_49);
}
vec2 l9_71=vec2(l9_68,l9_70);
float l9_72=((l9_47/1.000001)*(clamp((((shapeRoundness-0.001)/((0.0099999998-0.001)+1e-06))*(0.16-0.0))+0.0,0.0,0.16)-0.0))+0.0;
float l9_73=(((shapeRoundness-0.0)/l9_10)*(1.0-l9_72))+l9_72;
float l9_74;
if (1.0>l9_72)
{
l9_74=clamp(l9_73,l9_72,1.0);
}
else
{
l9_74=clamp(l9_73,1.0,l9_72);
}
float l9_75=abs(l9_74);
float l9_76=min(l9_75,l9_68);
float l9_77=min(l9_76,l9_70);
float l9_78=max(l9_77,0.001);
vec2 l9_79=vec2(l9_78);
float l9_80=1.0-(length(max((l9_48-l9_71)+l9_79,vec2(0.0)))/l9_78);
vec4 l9_81=vec4(l9_1.x,l9_1.y,l9_1.z,vec4(0.0).w);
l9_81.w=((clamp(((shapeAlpha*(clamp(l9_65+0.001,0.001,1.001)-0.001))+((clamp(((clamp((1.0-l9_65)+0.001,0.001,1.001)-0.001)*(clamp((l9_80/((((fwidth(l9_80)-0.0)/1.000001)*l9_9)+0.0))+0.001,0.001,1.001)-0.001))+0.001,0.001,1.001)-0.001)*0.0))+0.001,0.001,1.001)-0.001)*0.0)*l9_0;
vec2 l9_82=abs(((vec2(dot(l9_45,l9_35),dot(l9_46,l9_35))+vec2(0.5))*vec2(2.0))+vec2(-1.0));
float l9_83=1.0-(length(max((l9_82-l9_57)+l9_61,vec2(0.0)))/l9_60);
float l9_84=fwidth(l9_83);
float l9_85=clamp((l9_83/l9_84)+0.001,0.001,1.001)-0.001;
float l9_86=1.0-(length(max((l9_82-l9_71)+l9_79,vec2(0.0)))/l9_78);
float l9_87=fwidth(l9_86);
float l9_88=(clamp(((1.0-l9_85)*(clamp((l9_86/l9_87)+0.001,0.001,1.001)-0.001))+0.001,0.001,1.001)-0.001)*0.0;
float l9_89=l9_85*shapeAlpha;
float l9_90;
#if (shapeColorInvert)
{
l9_90=1.001;
...
float l9_93=((((((l9_88+l9_89)-max(l9_88,l9_89))+l9_89)-0.0)/l9_10)*(l9_91-l9_92))+l9_92;
float l9_94;
if (l9_91>l9_92)
{
l9_94=clamp(l9_93,l9_92,l9_91);
}
else
{
l9_94=clamp(l9_93,l9_91,l9_92);
}
vec4 l9_95=vec4(l9_94);
vec4 l9_96=mix(mix(mix(l9_81,vec4(0.0),vec4(l9_0*l9_85)),vec4(baseColor.xyz,1.0),l9_95),vec4(0.0),vec4(l9_88));
float l9_97=l9_96.w;
...
{
l9_100=clamp(l9_97*2.0,0.0,1.0);
}
#else
{
float l9_101;
...
{
l9_101=clamp(dot(l9_96.xyz,vec3(l9_97)),0.0,1.0);
}
#else
{
float l9_102;
...
{
l9_103=(1.0-dot(l9_96.xyz,vec3(0.33333001)))*l9_97;
}
#else
{
float l9_104;
...
{
l9_104=(1.0-clamp(dot(l9_96.xyz,vec3(1.0)),0.0,1.0))*l9_97;
}
#else
{
float l9_105;
...
{
l9_105=clamp(dot(l9_96.xyz,vec3(1.0)),0.0,1.0)*l9_97;
}
#else
{
float l9_106;
#if (sc_BlendMode_Add)
{
l9_106=clamp(dot(l9_96.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_107;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_107=clamp(dot(l9_96.xyz,vec3(1.0)),0.0,1.0)*l9_97;
}
#else
{
float l9_108;
...
{
l9_108=dot(l9_96.xyz,vec3(0.33333001))*l9_97;
}
#else
{
float l9_109;
#if (sc_BlendMode_Min)
{
l9_109=1.0-clamp(dot(l9_96.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_110;
#if (sc_BlendMode_Max)
{
l9_110=clamp(dot(l9_96.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_110=1.0;
...
#endif
l9_98=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_96.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_99);
}
#else
{
vec4 l9_111;
...
#if (sc_FramebufferFetch)
{
l9_113=sc_readFragData0_Platform();
}
#else
{
...
{
l9_115=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_114,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_115=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_114,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_113=l9_115;
}
#endif
vec3 l9_116=mix(l9_113.xyz,definedBlend(l9_113.xyz,l9_96.xyz).xyz,vec3(l9_97));
vec4 l9_117=vec4(l9_116.x,l9_116.y,l9_116.z,vec4(0.0).w);
l9_117.w=1.0;
l9_112=l9_117;
}
#else
...
#if (sc_Voxelization)
{
l9_118=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_119;
#if (sc_OutputBounds)
{
float l9_120=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_119=vec4(l9_120,1.0-l9_120,1.0,1.0);
}
#else
{
vec4 l9_121;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_121=vec4(mix(vec3(1.0),l9_96.xyz,vec3(l9_97)),l9_97);
}
#else
{
vec4 l9_122;
...
#endif
l9_122=vec4(l9_96.xyz*l9_123,l9_123);
}
#else
{
l9_122=l9_96;
...
#endif
vec4 l9_124=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_98,vec4(0.0)));
vec4 l9_125=clamp(l9_124,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_126=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_126-0.0039215689)),min(1.0,l9_126+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_127=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_127).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_128=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_127).xy);
float l9_129=packValue(l9_128);
int l9_136=int(l9_125.w*255.0);
float l9_137=packValue(l9_136);
sc_writeFragData0Internal(vec4(packValue(l9_128),packValue(l9_128),packValue(l9_128),packValue(l9_128)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_129,packValue(l9_128),packValue(l9_128),packValue(l9_128)));
sc_writeFragData2(vec4(l9_137,packValue(l9_136),packValue(l9_136),packValue(l9_136)));
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_140).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_145==0)
{
l9_148=texture(sc_OITAlpha0,l9_140);
l9_147=texture(sc_OITDepthLow0,l9_140);
l9_146=texture(sc_OITDepthHigh0,l9_140);
}
else
{
l9_148=vec4(0.0);
...
if (l9_145==1)
{
l9_151=texture(sc_OITAlpha1,l9_140);
l9_150=texture(sc_OITDepthLow1,l9_140);
l9_149=texture(sc_OITDepthHigh1,l9_140);
}
else
{
l9_151=l9_148;
...
if (any(notEqual(l9_149,vec4(0.0)))||any(notEqual(l9_150,vec4(0.0))))
{
int l9_152[8]=l9_141;
unpackValues(l9_149.w,l9_145,l9_152);
unpackValues(l9_149.z,l9_145,l9_152);
unpackValues(l9_149.y,l9_145,l9_152);
unpackValues(l9_149.x,l9_145,l9_152);
unpackValues(l9_150.w,l9_145,l9_152);
unpackValues(l9_150.z,l9_145,l9_152);
unpackValues(l9_150.y,l9_145,l9_152);
unpackValues(l9_150.x,l9_145,l9_152);
int l9_161[8]=l9_142;
unpackValues(l9_151.w,l9_145,l9_161);
unpackValues(l9_151.z,l9_145,l9_161);
unpackValues(l9_151.y,l9_145,l9_161);
unpackValues(l9_151.x,l9_145,l9_161);
}
l9_145++;
continue;
}
...
mediump vec4 l9_166=texture(sc_OITFilteredDepthBoundsTexture,l9_140);
vec2 l9_167=l9_166.xy;
int l9_168;
#if (sc_SkinBonesCount>0)
{
l9_168=encodeDepth(((1.0-l9_166.x)*1000.0)+getDepthOrderingEpsilon(),l9_167);
}
#else
{
l9_168=0;
...
#endif
int l9_169=encodeDepth(viewSpaceDepth(),l9_167);
vec4 l9_170;
l9_170=l9_125*l9_125.w;
vec4 l9_171;
int l9_172=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_172<8)
{
int l9_173=l9_141[l9_172];
int l9_174=l9_169-l9_168;
bool l9_175=l9_173<l9_174;
bool l9_176;
if (l9_175)
{
l9_176=l9_141[l9_172]>0;
}
else
{
l9_176=l9_175;
...
if (l9_176)
{
vec3 l9_177=l9_170.xyz*(1.0-(float(l9_142[l9_172])/255.0));
l9_171=vec4(l9_177.x,l9_177.y,l9_177.z,l9_170.w);
}
else
{
l9_171=l9_170;
...
#else
{
sc_writeFragData0Internal(l9_124,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif
