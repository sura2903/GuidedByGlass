...
//spec_const bool shapeColorInvert 71 0
...
float l9_5=floor(float(xLeftPin));
bool l9_6=l9_5==0.0;
float l9_7;
if (l9_6)
{
l9_7=Port_Value0_N281;
}
else
{
float l9_8;
if (l9_5==1.0)
{
l9_8=(Port_Value_N288+0.001)-0.001;
}
else
{
l9_8=Port_Default_N281;
}
l9_7=l9_8;
}
float l9_9=l9_7-l9_3;
float l9_10=(((shapeWidthX-Port_RangeMinA_N268)/((Port_RangeMaxA_N268-Port_RangeMinA_N268)+1e-06))*l9_9)+l9_3;
float l9_11;
if (l9_7>l9_3)
{
l9_11=clamp(l9_10,l9_3,l9_7);
}
else
{
l9_11=clamp(l9_10,l9_7,l9_3);
}
float l9_12;
if (l9_6)
{
l9_12=Port_Value0_N282;
}
else
{
float l9_13;
if (l9_5==1.0)
{
l9_13=Port_Value1_N282;
}
else
{
l9_13=Port_Default_N282;
}
l9_12=l9_13;
}
float l9_14=xOffset+l9_12;
float l9_15=l9_11+((1.0-l9_14)+Port_Value0_N308);
float l9_16=floor(float(yUpPin));
float l9_17;
if (l9_16==0.0)
{
l9_17=Port_Value0_N289;
}
else
{
float l9_18;
if (l9_16==1.0)
{
l9_18=(Port_Value_N288+0.001)-0.001;
}
else
{
l9_18=Port_Default_N289;
}
l9_17=l9_18;
}
float l9_19=floor(float(yDownPin));
bool l9_20=l9_19==0.0;
float l9_21;
if (l9_20)
{
l9_21=Port_Value0_N286;
}
else
{
float l9_22;
if (l9_19==1.0)
{
l9_22=(Port_Value_N288+0.001)-0.001;
}
else
{
l9_22=Port_Default_N286;
}
l9_21=l9_22;
}
float l9_23=l9_21-l9_17;
float l9_24=(((shapeHeightY-Port_RangeMinA_N277)/((Port_RangeMaxA_N277-Port_RangeMinA_N277)+1e-06))*l9_23)+l9_17;
float l9_25;
if (l9_21>l9_17)
{
l9_25=clamp(l9_24,l9_17,l9_21);
}
else
{
l9_25=clamp(l9_24,l9_21,l9_17);
}
float l9_26;
if (l9_20)
{
l9_26=Port_Value0_N293;
}
else
{
float l9_27;
if (l9_19==1.0)
{
l9_27=Port_Value1_N293;
}
else
{
l9_27=Port_Default_N293;
}
l9_26=l9_27;
}
float l9_28=yOffset+l9_26;
float l9_29=l9_25+(l9_28+Port_Value0_N301);
vec2 l9_30=((varPackedTex.xy*Port_Value0_N154.xy)+Port_Input2_N148)+vec2(l9_15,l9_29);
float l9_31=radians(Port_Value0_N132);
float l9_32=sin(l9_31);
float l9_33=cos(l9_31);
vec2 l9_34=l9_30-Port_Center_N092;
float l9_35=radians(1.0-(Port_Value0_N132+Port_Input1_N263));
float l9_36=sin(l9_35);
float l9_37=cos(l9_35);
vec2 l9_38=((vec2(dot(vec2(l9_33,l9_32),l9_34),dot(vec2(-l9_32,l9_33),l9_34))+Port_Center_N092)+vec2(Port_Value1_N097,Port_Value0_N131/Port_Input1_N160))-Port_Center_N094;
float l9_39=radians(shapeRotation);
float l9_40=sin(l9_39);
float l9_41=cos(l9_39);
vec2 l9_42=(vec2(dot(vec2(l9_37,l9_36),l9_38),dot(vec2(-l9_36,l9_37),l9_38))+Port_Center_N094)-Port_Center_N100;
vec2 l9_43=vec2(l9_41,l9_40);
vec2 l9_44=vec2(-l9_40,l9_41);
float l9_45=(((Port_Value0_N125-Port_RangeMinA_N138)/((Port_RangeMaxA_N138-Port_RangeMinA_N138)+1e-06))*(Port_RangeMaxB_N138-Port_RangeMinB_N138))+Port_RangeMinB_N138;
float l9_46;
if (Port_RangeMaxB_N138>Port_RangeMinB_N138)
{
l9_46=clamp(l9_45,Port_RangeMinB_N138,Port_RangeMaxB_N138);
}
else
{
l9_46=clamp(l9_45,Port_RangeMaxB_N138,Port_RangeMinB_N138);
}
vec2 l9_47=vec2(l9_46);
vec2 l9_48=abs((((((vec2(dot(l9_43,l9_42),dot(l9_44,l9_42))+Port_Center_N100)-Port_Center_N137)*l9_47)+Port_Center_N137)*vec2(Port_Input1_N003))+vec2(Port_Input1_N006));
float l9_49=Port_Value0_N122/Port_Input1_N056;
float l9_50=1.0-l9_49;
float l9_51=(((shapeWidthX-Port_RangeMinA_N018)/((Port_RangeMaxA_N018-Port_RangeMinA_N018)+1e-06))*(l9_50-Port_RangeMinB_N018))+Port_RangeMinB_N018;
float l9_52;
if (l9_50>Port_RangeMinB_N018)
{
l9_52=clamp(l9_51,Port_RangeMinB_N018,l9_50);
}
else
{
l9_52=clamp(l9_51,l9_50,Port_RangeMinB_N018);
}
float l9_53=(((shapeHeightY-Port_RangeMinA_N022)/((Port_RangeMaxA_N022-Port_RangeMinA_N022)+1e-06))*(l9_50-Port_RangeMinB_N022))+Port_RangeMinB_N022;
float l9_54;
if (l9_50>Port_RangeMinB_N022)
{
l9_54=clamp(l9_53,Port_RangeMinB_N022,l9_50);
}
else
{
l9_54=clamp(l9_53,l9_50,Port_RangeMinB_N022);
}
vec2 l9_55=vec2(l9_52,l9_54);
float l9_56=min(abs(shapeRoundness),l9_52);
float l9_57=min(l9_56,l9_54);
float l9_58=max(l9_57,Port_Input1_N012);
float l9_59=1.0-(length(max((l9_48-l9_55)+vec2(l9_58),Port_Input1_N031))/l9_58);
float l9_60=fwidth(l9_59);
float l9_61=Port_Value0_N125*Port_Input1_N127;
float l9_62=l9_59/((((l9_60-Port_RangeMinA_N135)/((Port_RangeMaxA_N135-Port_RangeMinA_N135)+1e-06))*(Port_RangeMaxB_N135-l9_61))+l9_61);
float l9_63=(((shapeWidthX-Port_RangeMinA_N019)/((Port_RangeMaxA_N019-Port_RangeMinA_N019)+1e-06))*(Port_RangeMaxB_N019-l9_49))+l9_49;
float l9_64;
if (Port_RangeMaxB_N019>l9_49)
{
l9_64=clamp(l9_63,l9_49,Port_RangeMaxB_N019);
}
else
{
l9_64=clamp(l9_63,Port_RangeMaxB_N019,l9_49);
}
float l9_65=(((shapeHeightY-Port_RangeMinA_N042)/((Port_RangeMaxA_N042-Port_RangeMinA_N042)+1e-06))*(Port_RangeMaxB_N042-l9_49))+l9_49;
float l9_66;
if (Port_RangeMaxB_N042>l9_49)
{
l9_66=clamp(l9_65,l9_49,Port_RangeMaxB_N042);
}
else
{
l9_66=clamp(l9_65,Port_RangeMaxB_N042,l9_49);
}
vec2 l9_67=vec2(l9_64,l9_66);
float l9_68=(((shapeRoundness-Port_RangeMinA_N057)/((Port_RangeMaxA_N057-Port_RangeMinA_N057)+1e-06))*(Port_RangeMaxB_N057-Port_RangeMinB_N057))+Port_RangeMinB_N057;
float l9_69;
if (Port_RangeMaxB_N057>Port_RangeMinB_N057)
{
l9_69=clamp(l9_68,Port_RangeMinB_N057,Port_RangeMaxB_N057);
}
else
{
l9_69=clamp(l9_68,Port_RangeMaxB_N057,Port_RangeMinB_N057);
}
float l9_70=l9_69-Port_RangeMinB_N101;
float l9_71=(((Port_Value0_N122-Port_RangeMinA_N101)/((Port_RangeMaxA_N101-Port_RangeMinA_N101)+1e-06))*l9_70)+Port_RangeMinB_N101;
float l9_72=(((shapeRoundness-Port_RangeMinA_N047)/((Port_RangeMaxA_N047-Port_RangeMinA_N047)+1e-06))*(Port_RangeMaxB_N047-l9_71))+l9_71;
float l9_73;
if (Port_RangeMaxB_N047>l9_71)
{
l9_73=clamp(l9_72,l9_71,Port_RangeMaxB_N047);
}
else
{
l9_73=clamp(l9_72,Port_RangeMaxB_N047,l9_71);
}
float l9_74=abs(l9_73);
float l9_75=min(l9_74,l9_64);
float l9_76=min(l9_75,l9_66);
float l9_77=max(l9_76,Port_Input1_N026);
float l9_78=1.0-(length(max((l9_48-l9_67)+vec2(l9_77),Port_Input1_N035))/l9_77);
vec4 l9_79=vec4(l9_1.x,l9_1.y,l9_1.z,vec4(0.0).w);
l9_79.w=((clamp(((shapeAlpha*(clamp(l9_62+0.001,Port_Input1_N017+0.001,Port_Input2_N017+0.001)-0.001))+((clamp(((clamp((1.0-l9_62)+0.001,Port_Input1_N264+0.001,Port_Input2_N264+0.001)-0.001)*(clamp((l9_78/((((fwidth(l9_78)-Port_RangeMinA_N133)/((Port_RangeMaxA_N133-Port_RangeMinA_N133)+1e-06))*(Port_RangeMaxB_N133-Port_Value0_N125))+Port_Value0_N125))+0.001,Port_Input1_N015+0.001,Port_Input2_N015+0.001)-0.001))+0.001,Port_Input1_N043+0.001,Port_Input2_N043+0.001)-0.001)*Port_Value0_N064))+0.001,Port_Input1_N052+0.001,Port_Input2_N052+0.001)-0.001)*Port_Value0_N123)*l9_0;
vec2 l9_80=l9_30-Port_Center_N113;
vec2 l9_81=abs(((vec2(dot(l9_43,l9_80),dot(l9_44,l9_80))+Port_Center_N113)*vec2(Port_Input1_N089))+vec2(Port_Input1_N090));
float l9_82=max(l9_57,Port_Input1_N103);
float l9_83=1.0-(length(max((l9_81-l9_55)+vec2(l9_82),Port_Input1_N105))/l9_82);
float l9_84=fwidth(l9_83);
float l9_85=(l9_83/l9_84)+0.001;
float l9_86=clamp(l9_85,Port_Input1_N112+0.001,Port_Input2_N112+0.001)-0.001;
float l9_87=max(l9_76,Port_Input1_N077);
float l9_88=1.0-(length(max((l9_81-l9_67)+vec2(l9_87),Port_Input1_N079))/l9_87);
float l9_89=fwidth(l9_88);
float l9_90=(clamp(((1.0-(clamp(l9_85,Port_Input1_N265+0.001,Port_Input2_N265+0.001)-0.001))*(clamp((l9_88/l9_89)+0.001,Port_Input1_N098+0.001,Port_Input2_N098+0.001)-0.001))+0.001,Port_Input1_N116+0.001,Port_Input2_N116+0.001)-0.001)*Port_Value0_N064;
float l9_91=l9_86*shapeAlpha;
float l9_92;
#if (shapeColorInvert)
{
l9_92=1.001;
...
float l9_94=1.0-l9_93;
float l9_95=((((((l9_90+l9_91)-max(l9_90,l9_91))+l9_91)-Port_RangeMinA_N143)/((Port_RangeMaxA_N143-Port_RangeMinA_N143)+1e-06))*(l9_93-l9_94))+l9_94;
float l9_96;
if (l9_93>l9_94)
{
l9_96=clamp(l9_95,l9_94,l9_93);
}
else
{
l9_96=clamp(l9_95,l9_93,l9_94);
}
vec4 l9_97=vec4(l9_96);
vec4 l9_98=mix(mix(mix(l9_79,vec4(Port_Input1_N259),vec4(l9_0*l9_86)),vec4(baseColor.xyz,1.0),l9_97),Port_Value0_N140,vec4(l9_90));
float l9_99=l9_98.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_99<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_99<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_102=clamp(l9_99*2.0,0.0,1.0);
}
#else
{
float l9_103;
...
{
l9_103=clamp(dot(l9_98.xyz,vec3(l9_99)),0.0,1.0);
}
#else
{
float l9_104;
...
{
l9_105=(1.0-dot(l9_98.xyz,vec3(0.33333001)))*l9_99;
}
#else
{
float l9_106;
...
{
l9_106=(1.0-clamp(dot(l9_98.xyz,vec3(1.0)),0.0,1.0))*l9_99;
}
#else
{
float l9_107;
...
{
l9_107=clamp(dot(l9_98.xyz,vec3(1.0)),0.0,1.0)*l9_99;
}
#else
{
float l9_108;
#if (sc_BlendMode_Add)
{
l9_108=clamp(dot(l9_98.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_109;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_109=clamp(dot(l9_98.xyz,vec3(1.0)),0.0,1.0)*l9_99;
}
#else
{
float l9_110;
...
{
l9_110=dot(l9_98.xyz,vec3(0.33333001))*l9_99;
}
#else
{
float l9_111;
#if (sc_BlendMode_Min)
{
l9_111=1.0-clamp(dot(l9_98.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_112;
#if (sc_BlendMode_Max)
{
l9_112=clamp(dot(l9_98.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_112=1.0;
...
#endif
l9_100=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_98.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_101);
}
#else
{
vec4 l9_113;
...
#if (sc_FramebufferFetch)
{
l9_115=sc_readFragData0_Platform();
}
#else
{
...
#endif
l9_115=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_116,sc_ScreenTextureLayout,l9_117).xy,0.0);
}
#endif
vec3 l9_118=mix(l9_115.xyz,definedBlend(l9_115.xyz,l9_98.xyz).xyz,vec3(l9_99));
...
#if (sc_Voxelization)
{
l9_120=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_121;
#if (sc_OutputBounds)
{
float l9_122=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_121=vec4(l9_122,1.0-l9_122,1.0,1.0);
}
#else
{
vec4 l9_123;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_123=vec4(mix(vec3(1.0),l9_98.xyz,vec3(l9_99)),l9_99);
}
#else
{
vec4 l9_124;
...
#endif
l9_124=vec4(l9_98.xyz*l9_125,l9_125);
}
#else
{
l9_124=l9_98;
...
vec4 l9_128=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_126,vec4(0.0)));
