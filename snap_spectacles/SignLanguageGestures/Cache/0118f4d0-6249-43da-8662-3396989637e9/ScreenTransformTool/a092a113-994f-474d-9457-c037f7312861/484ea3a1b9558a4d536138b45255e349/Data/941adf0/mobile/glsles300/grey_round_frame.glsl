...
#endif
vec4 l9_121=mix(mix(mix(l9_104,vec4(0.0),vec4(l9_0*l9_108)),vec4(shapeColor.xyz,1.0),l9_118),l9_119,vec4(l9_111));
float l9_122=l9_121.w;
...
{
l9_125=clamp(l9_122*2.0,0.0,1.0);
}
#else
{
float l9_126;
...
{
l9_126=clamp(dot(l9_121.xyz,vec3(l9_122)),0.0,1.0);
}
#else
{
float l9_127;
...
{
l9_128=(1.0-dot(l9_121.xyz,vec3(0.33333001)))*l9_122;
}
#else
{
float l9_129;
...
{
l9_129=(1.0-clamp(dot(l9_121.xyz,vec3(1.0)),0.0,1.0))*l9_122;
}
#else
{
float l9_130;
...
{
l9_130=clamp(dot(l9_121.xyz,vec3(1.0)),0.0,1.0)*l9_122;
}
#else
{
float l9_131;
#if (sc_BlendMode_Add)
{
l9_131=clamp(dot(l9_121.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_132;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_132=clamp(dot(l9_121.xyz,vec3(1.0)),0.0,1.0)*l9_122;
}
#else
{
float l9_133;
...
{
l9_133=dot(l9_121.xyz,vec3(0.33333001))*l9_122;
}
#else
{
float l9_134;
#if (sc_BlendMode_Min)
{
l9_134=1.0-clamp(dot(l9_121.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_135;
#if (sc_BlendMode_Max)
{
l9_135=clamp(dot(l9_121.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_135=1.0;
...
#endif
l9_123=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_121.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_124);
}
#else
{
vec4 l9_136;
...
#if (sc_FramebufferFetch)
{
l9_138=sc_readFragData0_Platform();
}
#else
{
...
{
l9_140=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_139,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_140=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_139,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_138=l9_140;
}
#endif
vec3 l9_141=mix(l9_138.xyz,definedBlend(l9_138.xyz,l9_121.xyz).xyz,vec3(l9_122));
...
#if (sc_Voxelization)
{
l9_143=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_144;
#if (sc_OutputBounds)
{
float l9_145=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_144=vec4(l9_145,1.0-l9_145,1.0,1.0);
}
#else
{
vec4 l9_146;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_146=vec4(mix(vec3(1.0),l9_121.xyz,vec3(l9_122)),l9_122);
}
#else
{
vec4 l9_147;
...
#endif
l9_147=vec4(l9_121.xyz*l9_148,l9_148);
}
#else
{
l9_147=l9_121;
...
#endif
vec4 l9_149=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_123,vec4(0.0)));
