...
//spec_const bool Tweak_N103 34 0
...
float l9_3=(0.75+0.001)-0.001;
float l9_4=l9_2*l9_3;
float l9_5=l9_0.x;
float l9_6=divisions_guides*2.0;
float l9_7=l9_6+1.234e-06;
float l9_8=l9_2*2.0;
float l9_9=colorjs.w*(clamp(max(clamp((max(step(fract((l9_1*divisions_guides)+(l9_4/2.0000012)),l9_4),step(fract((l9_5*divisions_guides)+(l9_2/(divisions_guides+1.234e-06))),l9_2))*alpha1)+0.001,0.001,1.001)-0.001,(max(step(fract((l9_1*l9_6)+(l9_4/l9_7)),l9_4),step(fract((l9_5*l9_6)+(l9_8/l9_7)),l9_8))*alpha2)*(1.0/(zoom+1.234e-06)))+0.001,0.001,1.001)-0.001);
float l9_10=l9_2*center_l_thickness_js;
float l9_11=l9_10*l9_3;
float l9_12=Tweak_N105.w*(clamp(max(step(fract((l9_1*2.0)+(l9_11/2.0000012)),l9_11)-max(float(l9_1<0.23999999),float(l9_1>0.79000002)),step(fract((l9_5*2.0)+(l9_10/2.0000012)),l9_10)-max(float(l9_5<0.23999999),float(l9_5>0.79000002)))+0.001,0.001,1.001)-0.001);
vec3 l9_13=mix(vec4(colorjs.xyz,l9_9).xyz,vec4(Tweak_N105.xyz,l9_12).xyz,vec3(l9_12));
vec4 l9_14=vec4(l9_13.x,l9_13.y,l9_13.z,vec4(0.0).w);
l9_14.w=clamp((l9_9+l9_12)+0.001,0.001,1.001)-0.001;
Value1=l9_14;
Result=Value1;
}
#else
{
vec2 l9_15=((Globals.Surface_UVCoord0-vec2(0.5))*vec2(1.0))+vec2(0.5);
float l9_16=l9_15.y;
float l9_17=zoom*gline_thickness;
float l9_18=l9_17*((0.75+0.001)-0.001);
float l9_19=l9_15.x;
float l9_20=divisions_guides*2.0;
float l9_21=l9_20+1.234e-06;
float l9_22=l9_17*2.0;
Default=vec4(colorjs.xyz,colorjs.w*(clamp(max(clamp((max(step(fract((l9_16*divisions_guides)+(l9_18/2.0000012)),l9_18),step(fract((l9_19*divisions_guides)+(l9_17/(divisions_guides+1.234e-06))),l9_17))*alpha1)+0.001,0.001,1.001)-0.001,(max(step(fract((l9_16*l9_20)+(l9_18/l9_21)),l9_18),step(fract((l9_19*l9_20)+(l9_22/l9_21)),l9_22))*alpha2)*(1.0/(zoom+1.234e-06)))+0.001,0.001,1.001)-0.001));
Result=Default;
}
#endif
}
...
#endif
vec4 param_3;
Node100_If_else(0.0,vec4(0.0),vec4(0.0),param_3,ssGlobals(sc_Time.x,sc_Time.y,0.0,varPackedTex.xy));
vec4 l9_0=param_3;
