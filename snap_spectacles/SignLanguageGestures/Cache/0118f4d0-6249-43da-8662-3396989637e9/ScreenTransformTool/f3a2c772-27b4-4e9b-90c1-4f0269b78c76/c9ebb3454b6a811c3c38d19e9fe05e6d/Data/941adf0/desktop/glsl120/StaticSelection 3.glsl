...
{
l9_24=vec3(l9_21.x,(l9_21.y*0.5)+(0.5-(float(l9_22)*0.5)),0.0);
}
else
{
l9_24=vec3(l9_21,0.0);
}
l9_23=l9_24;
}
l9_20=texture2D(sc_ScreenTexture,l9_23.xy,0.0);
}
#endif
vec3 l9_25=mix(l9_20.xyz,definedBlend(l9_20.xyz,l9_5.xyz).xyz,vec3(l9_4));
