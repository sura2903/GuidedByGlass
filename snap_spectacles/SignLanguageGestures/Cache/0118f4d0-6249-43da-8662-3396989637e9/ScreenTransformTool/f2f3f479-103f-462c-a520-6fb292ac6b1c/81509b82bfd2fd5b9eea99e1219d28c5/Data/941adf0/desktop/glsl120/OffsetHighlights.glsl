...
varColor=color;
vec3 l9_6=varNormal;
float l9_7=float(l9_0);
float l9_8=fract(((l9_7*Port_Input1_N031)+1.0)/((Tweak_N1Size.x*Port_Input1_N032)+1.234e-06));
float l9_9=(((l9_7/(Tweak_N1Size.y+1.234e-06))*Port_Input1_N037)+1.0)/((Tweak_N1Size.y*Port_Input1_N039)+1.234e-06);
int l9_10;
...
#endif
bool l9_11=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N1)!=0));
float l9_12=l9_8;
sc_SoftwareWrapEarly(l9_12,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).x);
float l9_13=l9_12;
float l9_14=l9_9;
sc_SoftwareWrapEarly(l9_14,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).y);
float l9_15=l9_14;
vec2 l9_16;
float l9_17;
...
{
l9_18=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).x==3;
}
#else
{
l9_18=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0);
}
#endif
float l9_19=l9_13;
float l9_20=1.0;
sc_ClampUV(l9_19,Tweak_N1UvMinMax.x,Tweak_N1UvMinMax.z,l9_18,l9_20);
float l9_21=l9_19;
float l9_22=l9_20;
bool l9_23;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N1)
{
l9_23=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).y==3;
}
#else
{
l9_23=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0);
}
#endif
float l9_24=l9_15;
float l9_25=l9_22;
sc_ClampUV(l9_24,Tweak_N1UvMinMax.y,Tweak_N1UvMinMax.w,l9_23,l9_25);
l9_17=l9_25;
...
#endif
vec2 l9_26=sc_TransformUV(l9_16,(int(SC_USE_UV_TRANSFORM_Tweak_N1)!=0),Tweak_N1Transform);
float l9_27=l9_26.x;
float l9_28=l9_17;
sc_SoftwareWrapLate(l9_27,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).x,l9_11,l9_28);
float l9_29=l9_26.y;
float l9_30=l9_28;
sc_SoftwareWrapLate(l9_29,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).y,l9_11,l9_30);
float l9_31=l9_30;
vec3 l9_32=sc_SamplingCoordsViewToGlobal(vec2(l9_27,l9_29),Tweak_N1Layout,l9_10);
vec4 l9_33=texture2DLod(Tweak_N1,l9_32.xy,0.0);
vec4 l9_34;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N1)
{
l9_34=mix(Tweak_N1BorderColor,l9_33,vec4(l9_31));
}
#else
{
l9_34=l9_33;
...
float l9_56=l9_55;
vec3 l9_57=sc_SamplingCoordsViewToGlobal(vec2(l9_52,l9_54),baseTexLayout,l9_35);
vec4 l9_58=texture2DLod(baseTex,l9_57.xy,0.0);
vec4 l9_59;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
...
#endif
vec3 l9_60=l9_34.xyz-l9_59.xyz;
vec3 l9_61=vec3(l9_60.y,Port_Input0_N018-l9_60.x,Port_Value3_N012);
float l9_62=dot(l9_61,l9_61);
float l9_63;
if (l9_62>0.0)
{
l9_63=1.0/sqrt(l9_62);
}
else
{
l9_63=0.0;
}
vec3 l9_64=l9_61*l9_63;
float l9_65=(Port_Value_N020+0.001)-0.001;
vec3 l9_66;
vec3 l9_67;
vec3 l9_68;
if (l9_3)
{
l9_68=varTangent.xyz;
l9_67=varNormal;
l9_66=varPos;
}
else
...
l9_68=varTangent.xyz;
l9_67=l9_6;
l9_66=((mix(l9_64,l9_64*vec3(smoothstep(Port_Input0_N049,l9_65,clamp(l9_65-length(l9_61),Port_Input1_N042,l9_65))),vec3(0.001-0.001))*vec3(l9_4.x+Port_Input1_N016))*vec3(width*(cameraSize/(Port_Input1_N047+1.234e-06))))+(l9_59.xyz+(l9_60*vec3(l9_4.y)));
}
varPos=l9_66;
varNormal=normalize(l9_67);
vec3 l9_69=normalize(l9_68);
varTangent=vec4(l9_69.x,l9_69.y,l9_69.z,varTangent.w);
...
#if (sc_RenderingSpace==3)
{
l9_70=sc_ProjectionMatrixInverseArray[sc_GetStereoViewIndex()]*l9_1.position;
}
#else
{
vec4 l9_71;
#if (sc_RenderingSpace==2)
{
l9_71=sc_ViewMatrixArray[sc_GetStereoViewIndex()]*l9_1.position;
}
#else
{
vec4 l9_72;
#if (sc_RenderingSpace==1)
{
l9_72=sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_1.position;
}
#else
{
l9_72=l9_1.position;
...
#if (sc_RenderingSpace==4)
{
l9_74=(sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_1.position)*vec4(1.0/sc_Camera.aspect,1.0,1.0,1.0);
}
#else
{
vec4 l9_75;
#if (sc_RenderingSpace==2)
{
l9_75=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(varPos,1.0);
}
#else
{
vec4 l9_76;
#if (sc_RenderingSpace==1)
{
l9_76=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(varPos,1.0);
}
#else
{
l9_76=vec4(0.0);
...
#if (sc_RenderingSpace==1)
{
l9_77=sc_ModelMatrix*l9_1.position;
}
#else
{
l9_77=l9_1.position;
...
#endif
vec4 l9_78=sc_ProjectorMatrix*l9_77;
varShadowTex=((l9_78.xy/vec2(l9_78.w))*0.5)+vec2(0.5);
}
#endif
vec4 l9_79;
...
{
vec4 l9_81=l9_73;
l9_81.z=((log2(max(sc_Camera.clipPlanes.x,1.0+l9_73.w))*(2.0/log2(sc_Camera.clipPlanes.y+1.0)))-1.0)*l9_73.w;
l9_80=l9_81;
}
else
{
...
#if (sc_TAAEnabled)
{
vec2 l9_83=l9_79.xy+(sc_TAAJitterOffset*l9_79.w);
l9_82=vec4(l9_83.x,l9_83.y,l9_79.z,l9_79.w);
}
#else
{
l9_82=l9_79;
...
#endif
sc_SetClipPosition(l9_82);
#if (sc_Voxelization)
{
sc_Vertex_t l9_84=sc_Vertex_t(l9_1.position,l9_1.normal,l9_1.tangent,l9_4,l9_1.texture1);
sc_BlendVertex(l9_84);
sc_SkinVertex(l9_84);
int l9_85=sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID);
int l9_86=int(voxelization_params_0.w);
vec4 l9_87=createVoxelOrthoMatrix(voxelization_params_frustum_lrbt.x,voxelization_params_frustum_lrbt.y,voxelization_params_frustum_lrbt.z,voxelization_params_frustum_lrbt.w,voxelization_params_frustum_nf.x,voxelization_params_frustum_nf.y)*vec4(((sc_ModelMatrixVoxelization*l9_84.position).xyz+vec3(float(l9_85%l9_86)*voxelization_params_0.y,float(l9_85/l9_86)*voxelization_params_0.y,(float(l9_85)*(voxelization_params_0.y/voxelization_params_0.z))+voxelization_params_frustum_nf.x))-voxelization_params_camera_pos,1.0);
l9_87.w=1.0;
varScreenPos=l9_87;
sc_SetClipPosition(l9_87*1.0);
}
#else
{
#if (sc_OutputBounds)
{
sc_Vertex_t l9_88=sc_Vertex_t(l9_1.position,l9_1.normal,l9_1.tangent,l9_4,l9_1.texture1);
sc_BlendVertex(l9_88);
sc_SkinVertex(l9_88);
vec2 l9_89=((l9_88.position.xy/vec2(l9_88.position.w))*0.5)+vec2(0.5);
varPackedTex=vec4(l9_89.x,l9_89.y,varPackedTex.z,varPackedTex.w);
vec4 l9_90=sc_ModelMatrixVoxelization*l9_88.position;
vec3 l9_91=l9_90.xyz-voxelization_params_camera_pos;
varPos=l9_91.xyz;
varNormal=normalize(l9_88.normal);
vec4 l9_92=createVoxelOrthoMatrix(voxelization_params_frustum_lrbt.x,voxelization_params_frustum_lrbt.y,voxelization_params_frustum_lrbt.z,voxelization_params_frustum_lrbt.w,voxelization_params_frustum_nf.x,voxelization_params_frustum_nf.y)*vec4(l9_91.x,l9_91.y,l9_91.z,l9_90.w);
vec4 l9_93=vec4(l9_92.x,l9_92.y,l9_92.z,vec4(0.0).w);
l9_93.w=1.0;
varScreenPos=l9_93;
sc_SetClipPosition(l9_93*1.0);
}
#endif
}
#endif
...
#endif
l9_15=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_16,sc_ScreenTextureLayout,l9_17).xy,0.0);
}
#endif
