...
#endif
l9_26=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_27,sc_ScreenTextureLayout,l9_28).xy,0.0);
}
#endif
...
vec4 l9_39=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_37,vec4(0.0)));
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_41-0.0039215689)),min(1.0,l9_41+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_43),packValue(l9_43),packValue(l9_43),packValue(l9_43)),sc_UniformConstants.x,sc_ShaderCacheConstant);
...
#else
{
sc_writeFragData0Internal(l9_39,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif
