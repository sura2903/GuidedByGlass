...
#if (sc_FramebufferFetch)
{
l9_26=sc_readFragData0_Platform();
}
#else
{
...
{
l9_28=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_27,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_28=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_27,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_26=l9_28;
}
#endif
vec3 l9_29=mix(l9_26.xyz,definedBlend(l9_26.xyz,l9_10.xyz).xyz,vec3(l9_9));
...
#if (sc_Voxelization)
{
l9_31=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_32;
#if (sc_OutputBounds)
{
float l9_33=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_32=vec4(l9_33,1.0-l9_33,1.0,1.0);
}
#else
{
vec4 l9_34;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_34=vec4(mix(vec3(1.0),l9_10.xyz,vec3(l9_9)),l9_9);
}
#else
{
vec4 l9_35;
...
#endif
l9_35=vec4(l9_10.xyz*l9_36,l9_36);
}
#else
{
l9_35=l9_10;
...
#endif
vec4 l9_37=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_11,vec4(0.0)));
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_39-0.0039215689)),min(1.0,l9_39+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_41),packValue(l9_41),packValue(l9_41),packValue(l9_41)),sc_UniformConstants.x,sc_ShaderCacheConstant);
...
sc_writeFragData0Internal(l9_38,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
