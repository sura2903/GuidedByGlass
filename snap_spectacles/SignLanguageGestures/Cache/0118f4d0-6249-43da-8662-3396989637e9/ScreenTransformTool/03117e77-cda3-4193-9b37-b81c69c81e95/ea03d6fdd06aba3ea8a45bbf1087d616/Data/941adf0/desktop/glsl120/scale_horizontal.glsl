...
#if (sc_FramebufferFetch)
{
l9_23=sc_readFragData0_Platform();
}
#else
{
...
#endif
l9_23=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_24,sc_ScreenTextureLayout,l9_25).xy,0.0);
}
#endif
vec3 l9_26=mix(l9_23.xyz,definedBlend(l9_23.xyz,l9_7.xyz).xyz,vec3(l9_6));
...
#if (sc_Voxelization)
{
l9_28=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_29;
#if (sc_OutputBounds)
{
float l9_30=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_29=vec4(l9_30,1.0-l9_30,1.0,1.0);
}
#else
{
vec4 l9_31;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_31=vec4(mix(vec3(1.0),l9_7.xyz,vec3(l9_6)),l9_6);
}
#else
{
vec4 l9_32;
...
#endif
l9_32=vec4(l9_7.xyz*l9_33,l9_33);
}
#else
{
l9_32=l9_7;
...
vec4 l9_36=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_34,vec4(0.0)));
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_38-0.0039215689)),min(1.0,l9_38+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_40),packValue(l9_40),packValue(l9_40),packValue(l9_40)),sc_UniformConstants.x,sc_ShaderCacheConstant);
...
#else
{
sc_writeFragData0Internal(l9_36,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif
