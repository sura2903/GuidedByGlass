...
{
l9_25=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_24,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_25=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_24,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_23=l9_25;
}
...
#endif
vec4 l9_34=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_8,vec4(0.0)));
...
mediump vec4 l9_76=texture(sc_OITFilteredDepthBoundsTexture,l9_50);
vec2 l9_77=l9_76.xy;
int l9_78;
#if (sc_SkinBonesCount>0)
{
